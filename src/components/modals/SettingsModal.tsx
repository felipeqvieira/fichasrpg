...
import { Download, Upload, Trash2, X, Save, Moon, Sun } from 'lucide-react';
import type { CharacterSheet, Skill } from '../../types/dnd';
...
const INITIAL_SKILLS: Record<string, Skill> = {
  ...
  perception: { level: 'none', attribute: 'wisdom' },
  ...
  survival: { level: 'none', attribute: 'wisdom' },
};
...
const EMPTY_CHARACTER: CharacterSheet = {
  ...
  // --- NOVOS CAMPOS INICIALIZADOS VAZIOS ---
  armorProficiencies: [],
  weaponProficiencies: [],
  languages: [],
  senses: [],
